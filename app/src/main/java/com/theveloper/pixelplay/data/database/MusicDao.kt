...
interface MusicDao {
    ...
    suspend fun getAllYandexSongIds(): List<Long>
    ...
    @Transaction
    suspend fun clearAllYandexSongs() {
        val yandexSongIds = getAllYandexSongIds()
        if (yandexSongIds.isEmpty()) return
        deleteSongsAndRelatedData(yandexSongIds)
    }
